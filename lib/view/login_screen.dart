             ...
             Consumer<AuthProvider>(builder: (context,value,child){
              ...
              InkWell(
               ...
               Navigator.pushNamed(context, RoutesName.loginPhone);
                ...
                child: Container(height: 50,
                  ...
                  child: const Center(child: Text("Login with phone",style: TextStyle(fontSize:20),)),
              ...
              InkWell(
                ...
                child: Container(height: 50,
                  ...
                  child: const Center(child: Text("Login with goggle",style: TextStyle(fontSize:20),)),
                ),
              ),
              const SizedBox(height: 20),
              InkWell(
                ...
                child: Container(height: 50,
                  ...
                  child: const Center(child: Text("Login with Facebook",style: TextStyle(fontSize:20),)),
